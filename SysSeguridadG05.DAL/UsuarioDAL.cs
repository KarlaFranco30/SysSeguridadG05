    ...
    public class UsuarioDAL
    {
        ...
        public static async Task<int> GuardarAsync(Usuario pUsuario)
        {
            ...
            try
            {
                ...
                {
                    bool esiteLogin = await ExisteLogin(pUsuario, dbContexto);
                    if (esiteLogin == false)
                    {
        ...
        public static async Task<List<Usuario>> ObtenerTodoAsync()
        {
        ...
        public static async Task<List<Usuario>> BuscarInclurRolAsync(Usuario pUsuario)
        {
            var usuarios = new List<Usuario>();
            try
            {
        ...
        public static async Task<int> CambiarPasswordAsync(Usuario pUsuario, string pPasswordAnt)
        {
            ...
            using (var dbContexto = new DBContexto())
            {
                ...
                {
                    EncriptarMD5(pUsuario);
                    usuario.Password = usuarioPassAnt.Password;
                    dbContexto.Update(usuario);
                    result = await dbContexto.SaveChangesAsync();
                }
                else

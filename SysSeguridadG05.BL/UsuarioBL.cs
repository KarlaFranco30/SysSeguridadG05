...
namespace SysSeguridadG05.BL
{
    public class UsuarioBL
    {
        ...
        {
            return await UsuarioDAL.ObtenerTodoAsync();
        }
        ...
        public async Task<List<Usuario>> BuscarInclurRolAsync(Usuario pUsuario)
        {
            return await UsuarioDAL.BuscarInclurRolAsync(pUsuario);
        }
